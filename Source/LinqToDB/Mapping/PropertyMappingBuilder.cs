...
namespace LinqToDB.Mapping
{
	...
	public class PropertyMappingBuilder<TEntity, TProperty>
	{
		...
		/// <summary>
		/// Sets the <see cref="ColumnAttribute.IsIdentity"/> of the database column.
		/// </summary>
		/// <param name="isIdentity"><value>true</value> if column is auto-generated by database engine</param>
		/// <returns>Returns current column mapping builder.</returns>
		public PropertyMappingBuilder<TEntity, TProperty> HasIdentity(bool isIdentity)
			=> SetColumn(a => a.IsIdentity = isIdentity);
